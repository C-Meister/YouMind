...
>>>>>>> bd9fe3fc3e1ff45c9a13a2fac478e7757c038a5f
    ...
    def add_download_list(self, downloaddata):  # 함수명 알아서 바꾸셈
        ...
        self.ui.linked_p = [QtWidgets.QWidget(
            self.ui.layout_link_data) for i in range(length)]
        ...
        self.ui.linked_image = [QtWidgets.QLabel(
            self.ui.linked_p[i]) for i in range(length)]
        self.ui.linked_title = [QtWidgets.QLabel(
            self.ui.linked_p[i]) for i in range(length)]
        self.ui.linked_youtube_icon = [QtWidgets.QLabel(
            self.ui.linked_p[i]) for i in range(length)]
        self.ui.linked_id = [QtWidgets.QLabel(
            self.ui.linked_p[i]) for i in range(length)]
        ...
        for i in range(length):
            ...
            self.ui.linked_youtube_icon[i].setGeometry(
                QtCore.QRect(182, 80, 21, 21))
            self.ui.linked_youtube_icon[i].setStyleSheet(
                "image:url(./image/sub1.png);")
    ...
    def add_now_list(self, downloaddata):
        ...
        length = len(downloaddata)
        self.ui.now_panel = [QtWidgets.QWidget(
            self.ui.now_download_layout) for i in range(length)]
        ...
        self.ui.now_image = [QtWidgets.QLabel(
            self.ui.now_panel[i]) for i in range(length)]
        self.ui.now_youtube_icon = [QtWidgets.QLabel(
            self.ui.now_panel[i]) for i in range(length)]
        self.ui.now_title = [QtWidgets.QLabel(
            self.ui.now_panel[i]) for i in range(length)]
        ...
        for i in range(length):
            ...
            self.ui.now_youtube_icon[i] = QtWidgets.QLabel(
                self.ui.now_panel[i])
            self.ui.now_youtube_icon[i].setGeometry(
                QtCore.QRect(180, 55, 21, 21))
            self.ui.now_youtube_icon[i].setStyleSheet(
                "image:url(./image/sub1.png);")
